  ...
  var LevelSelector = /*#__PURE__*/function (_UICorePlugin) {
    ...
    _createClass(LevelSelector, [{
      ...
      value: function bindEvents() {
        this.listenTo(this.core, clapprCore.Events.CORE_READY, this.bindPlaybackEvents);
        if (clapprCore.Events.CORE_ACTIVE_CONTAINER_CHANGED) this.listenTo(this.core, clapprCore.Events.CORE_ACTIVE_CONTAINER_CHANGED, this.reload);else this.listenTo(this.core.mediaControl, clapprCore.Events.MEDIACONTROL_CONTAINERCHANGED, this.reload);
        this.listenTo(this.core.mediaControl, clapprCore.Events.MEDIACONTROL_RENDERED, this.render);
        this.listenTo(this.core.mediaControl, clapprCore.Events.MEDIACONTROL_HIDE, this.hideSelectLevelMenu);
      }
    }, {
      key: "bindPlaybackEvents",
      value: function bindPlaybackEvents() {
        if (!this.playback) return;
        this.listenTo(this.playback, clapprCore.Events.PLAYBACK_LEVELS_AVAILABLE, this.fillLevels);
        this.listenTo(this.playback, clapprCore.Events.PLAYBACK_LEVEL_SWITCH_START, this.startLevelSwitch);
        this.listenTo(this.playback, clapprCore.Events.PLAYBACK_LEVEL_SWITCH_END, this.stopLevelSwitch);
        this.listenTo(this.playback, clapprCore.Events.PLAYBACK_BITRATE, this.updateCurrentLevel);
